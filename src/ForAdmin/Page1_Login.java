...
public class Page1_Login extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel29.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 0, 30, 40));
    ...
    private void btnLoginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnLoginActionPerformed
        ...
        AdminSession startSession = new AdminSession(); 
        ...
        if(userEmail.trim().equals("") || userEmail.trim().equals("someone@newmail.com")){
            ...
            try {
                ...
                sqlQueryCheck = conn.prepareStatement("select * from tbl_admin where email=?");
                    ...
                    while(res.next()) {
                        ...
                        if (retrievePass.equals(userPass)) {
                            ...
                            if(startSession.isLogin(userEmail, userPass, this)){
                                ...
                                sqlQueryLogin = conn.prepareStatement("update tbl_admin SET status='Online' WHERE email=? ");
